...
onMounted(async () => {
  try {
    const result = await axios.get(`/v1/supplier-groups/${route.params.id}`)
...
<template>
  <div class="main-content-container">
    <div class="main-content-header">
      ...
      <component
        :is="BaseBreadcrumb"
        :breadcrumbs="[{ name: 'Supplier Group', path: '/supplier-group' }, { name: route.params.id.toString() }]"
      />
    </div>
    <div class="main-content-body">
      <div class="card card-template">
        <div class="card-header bg-slate-200 dark:bg-slate-700 px-4 py-2 -mx-4 -my-2 font-extrabold">
          <h2>Show Supplier Group</h2>
          <div class="flex gap-2 overflow-x-hidden">
            <div>
              <router-link to="/supplier-group/create" class="btn btn-secondary btn-sm rounded-none space-x-1">
            ...
            <div>
              <router-link
                :to="`/supplier-group/${route.params.id}/edit`"
