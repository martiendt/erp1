...
const onSubmit = async () => {
  try {
    ...
    const response = await axios.post('/v1/allocation-groups', form.value)
...
<template>
  <div class="main-content-container">
    <div class="main-content-header">
      ...
      <component
        :is="BaseBreadcrumb"
        :breadcrumbs="[{ name: 'Allocation Group', path: '/allocation-group' }, { name: 'Create' }]"
      />
    </div>
    <div class="main-content-body">
      <div class="card card-template">
        <div class="card-header">
          <h2>New Allocation Group</h2>
        </div>
