...
const onSubmit = async () => {
  try {
    ...
    const response = await axios.patch(`/v1/allocation-groups/${_id.value}`, form.value)
  ...
  <div class="main-content-container">
    <div class="main-content-header">
      ...
      <component
        :is="BaseBreadcrumb"
        :breadcrumbs="[
          { name: 'Allocation Group', path: '/allocation-group' },
          { name: route.params.id.toString(), path: `/allocation-group/${route.params.id.toString()}` },
          { name: 'Edit' }
        ]"
      />
    </div>
